...
;// ./src/scenes/shared.tsx



const clamp = (value, min, max) => Math.max(min, Math.min(max, value));
const typed = (text, count) => text.slice(0, clamp(Math.floor(count), 0, text.length));
const glassStyle = {
...
const veevaLogoSrc = `data:image/svg+xml,${encodeURIComponent(`
...
const Particles = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { pointerEvents: "none", opacity }, children: particles.map((p) => {
...
;// ./src/scenes/CognizantWatermark.tsx




const CognizantWatermark = () => {
  ...
  const moveProgress = (0,esm.interpolate)(frame, [160, 220], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const startLeft = width / 2 - 260;
  const startTop = height / 2 - 90;
  const left = (0,esm.interpolate)(moveProgress, [0, 1], [startLeft, 32]);
  const top = (0,esm.interpolate)(moveProgress, [0, 1], [startTop, 28]);
  const scale = (0,esm.interpolate)(moveProgress, [0, 1], [1, 0.82]);
  const text = typed("Cognizant", (frame - 30) / 4.5);
  const subOpacity = (0,esm.interpolate)(frame, [100, 140], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const logoX = (0,esm.interpolate)(logoSpring, [0, 1], [-80, 0]);
  const logoScale = (0,esm.interpolate)(logoSpring, [0, 1], [0.95, 1]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 16 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                ...
                height: 56,
                borderRadius: 16,
                background: "linear-gradient(135deg, #2d6dad, #0b2f57)",
                transform: `translateX(${logoX}px) scale(${logoScale})`,
                boxShadow: "0 8px 20px rgba(16,60,103,0.28)"
              }
            }
          ),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              fontFamily: "Avenir Next, Segoe UI, Tahoma, sans-serif",
              fontSize: 20,
              color: "rgba(10,38,68,0.72)",
              opacity: subOpacity
            },
            children: "Life Sciences Digital Transformation"
          }
        )
      ]
    }
...
;// ./src/scenes/timeline.ts

const SCENE_1_START = 0;
const SCENE_1_END = 240;
const SCENE_2_START = SCENE_1_END;
const SCENE_2_END = 600;
const SCENE_3_START = SCENE_2_END;
const SCENE_3_END = 1020;
const TRANSFORM_START = SCENE_3_END;
const TRANSFORM_END = 1200;
const SCENE_4_START = TRANSFORM_END;
const SCENE_4_END = 1560;
const FINAL_START = SCENE_4_END;
const FINAL_END = 1800;
...
const FinalScene = ({ frame }) => {
  const local = frame - FINAL_START;
  const borderProgress = (0,esm.interpolate)(local, [0, 70], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const titleOp = (0,esm.interpolate)(local, [40, 95], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const brandOp = (0,esm.interpolate)(local, [90, 145], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const subOp = (0,esm.interpolate)(local, [140, 200], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const fadeOut = (0,esm.interpolate)(local, [190, FINAL_END - FINAL_START], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    ...
    {
      style: {
        background: "radial-gradient(circle at 40% 20%, #112d4c 0%, #061327 65%, #030913 100%)"
      },
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(Particles, { frame: local + 300, opacity: 0.55 }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 1280, height: 720, style: { position: "absolute", inset: 0 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "rect",
          {
            x: 34,
            y: 34,
            width: 1212 * borderProgress,
            height: 652 * borderProgress,
            rx: 28,
            fill: "none",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: "From Complexity to Clarity"
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: "Cognizant + Veeva Vault"
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: "Transforming Life Sciences Architecture"
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
...
const SceneFour = ({ frame }) => {
  ...
  const cloudIn = (0,esm.interpolate)(local, [10, 60], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const node1 = (0,esm.interpolate)(local, [70, 120], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const node2 = (0,esm.interpolate)(local, [120, 170], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const node3 = (0,esm.interpolate)(local, [170, 220], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const statement1 = (0,esm.interpolate)(local, [220, 260], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const statement2 = (0,esm.interpolate)(local, [270, 310], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const statement3 = (0,esm.interpolate)(local, [320, 360], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const orbit = (text, angleOffset) => {
    const angle = (local / 25 + angleOffset) % (Math.PI * 2);
    return {
      text,
      x: 640 + Math.cos(angle) * 95,
      y: 360 + Math.sin(angle) * 55
    };
  };
  const orbitItems = [
    orbit("Data", 0),
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(Particles, { frame: local + 180, opacity: 0.7 }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              fontSize: 46,
              fontWeight: 600,
              boxShadow: "0 0 40px rgba(167,205,255,0.22)"
            },
            children: "Veeva Vault QMS"
          }
        ),
        [
          { title: "Customer Service", x: 160, y: 160, op: node1 },
          { title: "Regulatory", x: 900, y: 160, op: node2 },
          { title: "Quality Assurance", x: 500, y: 560, op: node3 }
        ].map((n) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...glassStyle,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width: 1280, height: 720, style: { position: "absolute", inset: 0 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "line",
            {
              x1: 330,
        ...
        orbitItems.map((item) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              position: "absolute",
...
;// ./src/scenes/SceneOne.tsx




const SceneOne = ({ frame }) => {
  const zoom = (0,esm.interpolate)(frame, [0, SCENE_1_END], [1, 1.03]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      style: {
...
;// ./src/scenes/SceneThree.tsx





const Cluster = ({ title, subtitle, x, y, appear, frame }) => {
  const local = frame - appear;
  const vis = (0,esm.interpolate)(local, [0, 30], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const pulse = 1 + Math.sin((frame + x) / 20) * 0.02;
  const dotRotate = frame * 2.2;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      style: {
        ...
        border: "1px solid rgba(30,56,92,0.15)",
        boxShadow: "0 12px 30px rgba(8,20,38,0.12)"
      },
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              height: 96,
              borderRadius: "50%",
              border: "2px dashed rgba(52,89,129,0.45)",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              height: 48,
              borderRadius: 12,
              background: "linear-gradient(160deg,#6d8fb4,#355880)",
              boxShadow: "0 8px 18px rgba(42,79,122,0.3)"
            }
          }
        ),
        Array.from({ length: 6 }).map((_, i) => {
          const angle = Math.PI * 2 * i / 6;
          const px = 160 + Math.cos(angle) * 86;
          const py = 136 + Math.sin(angle) * 62;
          return /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                ...
                height: 20,
                borderRadius: 6,
                background: "rgba(62,102,143,0.14)",
                border: "1px solid rgba(62,102,143,0.25)"
              }
            },
            `${title}-${i}`
          );
...
const SceneThree = ({ frame }) => {
  ...
  const arrowProgress = (start, end) => (0,esm.interpolate)(local, [start, end], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const draw1 = arrowProgress(180, 260);
  const draw2 = arrowProgress(220, 320);
  const draw3 = arrowProgress(260, 350);
  const overlayOpacity = (0,esm.interpolate)(local, [300, 340], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    ...
    {
      style: {
        background: "linear-gradient(165deg, #edf0f3 0%, #dfe5eb 100%)"
      },
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              border: "1px solid rgba(61,90,125,0.18)",
              color: "#2a435f",
              textAlign: "center",
              width: 520
            },
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 40, fontWeight: 600 }, children: "Before Veeva Vault" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 22, opacity: 0.82, marginTop: 6 }, children: "Disconnected Systems. Manual Coordination." })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          Cluster,
          {
            ...
            subtitle: "Complaints Information",
            x: 110,
            y: 130,
            appear: 30,
            frame: local
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              border: "1px solid rgba(58,91,127,0.2)",
              color: "#1e3551",
              textAlign: "center",
              lineHeight: 1.55,
              fontSize: 32,
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { children: "Data Silos" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { children: "Manual Reconciliation" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { children: "Compliance Risk" })
            ]
          }
        )
      ]
...
const SceneTwo = ({ frame }) => {
  ...
  const logoPop = (0,esm.spring)({
    frame: local,
    fps,
    config: { damping: 130, stiffness: 120 }
  });
  const logoScale = (0,esm.interpolate)(logoPop, [0, 1], [0.9, 1]);
  const logoOpacity = (0,esm.interpolate)(local, [0, 35], [0, 0.85], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const vX = (0,esm.interpolate)(local, [70, 130], [-90, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const eeva = typed("eeva", (local - 110) / 5);
  const vaultCount = clamp(Math.floor((local - 170) / 6), 0, 5);
  const vaultText = "Vault".slice(0, vaultCount);
  const vaultX = (0,esm.interpolate)(local, [170, 240], [70, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const taglineOpacity = (0,esm.interpolate)(local, [250, 300], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const shimmerX = (0,esm.interpolate)(local % 180, [0, 180], [-300, 420]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
        background: "radial-gradient(circle at 40% 20%, #1f3f66 0%, #07162c 65%, #030c1d 100%)"
      },
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(Particles, { frame: local, opacity: 0.9 }),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              borderRadius: 28,
              overflow: "hidden",
              boxShadow: "0 0 36px rgba(164,203,255,0.18)"
            },
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: veevaLogoSrc, style: { width: "100%", height: "100%", opacity: 0.85 } }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 96, fontWeight: 600, transform: `translateX(${vX}px)` }, children: "V" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 78, fontWeight: 500, letterSpacing: 1 }, children: eeva }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { width: 24 } }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "span",
                {
                  style: {
                    ...
                    fontWeight: 400,
                    letterSpacing: 1.4,
                    transform: `translateX(${vaultX}px)`
                  },
                  children: vaultText
                }
              )
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: "Powering Innovation in Life Sciences"
          }
        )
      ]
    }
...
;// ./src/scenes/TransformationScene.tsx





const TransformationScene = ({ frame }) => {
  const local = frame - TRANSFORM_START;
  const orangeSpread = (0,esm.interpolate)(local, [40, 150], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const navyFade = (0,esm.interpolate)(local, [100, 180], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const textOpacity = (0,esm.interpolate)(local, [12, 60], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const zoom = (0,esm.interpolate)(local, [0, 120], [1, 0.95], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(Particles, { frame: local + 50, opacity: 0.35 }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              color: "#f4f8ff",
              opacity: textOpacity,
              background: "rgba(13,30,52,0.36)",
              border: "1px solid rgba(194,220,255,0.25)",
              textAlign: "center",
              fontWeight: 500
            },
            children: "What if everything was unified?"
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              left: "50%",
              top: "50%",
              width: 1200 * orangeSpread,
              height: 1200 * orangeSpread,
              transform: "translate(-50%, -50%)",
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(251,147,60,0.46) 0%, rgba(251,147,60,0.12) 44%, rgba(251,147,60,0.02) 70%, rgba(251,147,60,0) 100%)"
            }
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              inset: 0,
              opacity: navyFade,
              background: "radial-gradient(circle at 50% 40%, #1a3658 0%, #07172d 66%, #050d1f 100%)"
            }
          }
        )
      ]
...
const MyComposition = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: SCENE_1_START, durationInFrames: SCENE_1_END - SCENE_1_START, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneOne, { frame }) }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: SCENE_2_START, durationInFrames: SCENE_2_END - SCENE_2_START, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTwo, { frame }) }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: SCENE_3_START, durationInFrames: SCENE_3_END - SCENE_3_START, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneThree, { frame }) }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.Sequence,
          {
            from: TRANSFORM_START,
            durationInFrames: TRANSFORM_END - TRANSFORM_START,
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(TransformationScene, { frame })
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: SCENE_4_START, durationInFrames: SCENE_4_END - SCENE_4_START, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneFour, { frame }) }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: FINAL_START, durationInFrames: FINAL_END - FINAL_START, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(FinalScene, { frame }) }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(CognizantWatermark, {})
      ]
    }
  );
};
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "Intro_Veeva_Vault_codex:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkIntro_Veeva_Vault_codex"] = self["webpackChunkIntro_Veeva_Vault_codex"] || [];
